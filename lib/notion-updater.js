    ...
    if (existingPages.results.length > 0) {
      ...
      await notion.pages.update({
        ...
        properties: {
          ...
          '총 개발시간': { rich_text: [{ text: { content: timeAnalysis.totalDevelopmentTime } }] }, // 띄어쓰기 없음
          'AI 구현 시간': { rich_text: [{ text: { content: timeAnalysis.aiImplementationTime } }] }, // 띄어쓰기 있음
          '리뷰/수정시간': { rich_text: [{ text: { content: timeAnalysis.humanReviewTime } }] } // 띄어쓰기 없음
        }
      });
