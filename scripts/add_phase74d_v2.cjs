...
if (!content.includes(marker)) {
  ...
  console.log('Looking for Phase 87...');
  if (content.includes('Phase 87')) {
    console.log('Phase 87 found but marker format differs');
  }
  process.exit(1);
}
...
content = content.replace(marker, phase74D + marker);
